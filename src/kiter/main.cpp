...
std::vector<algo_t> algorithmslist = {
		...
		{ "BackPressureSizing" , "Buffer sizing method from Wiggers et al DAC 2007 paper.", algorithms::compute_backpressure_memory_sizing},
                { "KPeriodicThroughputwithDSE" , "Combine buffer space exploration with throughput evaluation of CSDF by K-periodic scheduling method.", algorithms::compute_Kperiodic_throughput_dse},
